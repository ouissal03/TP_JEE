...
public class ScopedVars extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ScopedVars</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ScopedVars at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
request.setAttribute("attribute1", "toto");
HttpSession session = request.getSession();
session.setAttribute("attribute2", "lolo");
